  ...
  def __init__(self):
    ...
    self.parser.add_argument('--keep_res', action='store_true',
                             help='keep the original resolution'
                                  ' during validation.')
    # tracking
    self.parser.add_argument('--test_mot16', default=False, action='store_true', help='test mot16')
    self.parser.add_argument('--val_mot15', default=False, action='store_true', help='val mot15')
    self.parser.add_argument('--test_mot15', default=False, action='store_true', help='test mot15')
    self.parser.add_argument('--val_mot16', default=False, action='store_true', help='val mot16 or mot15')
    self.parser.add_argument('--test_mot17', default=False, action='store_true', help='test mot17')
    self.parser.add_argument('--val_mot17', default=False, action='store_true', help='val mot17')
    self.parser.add_argument('--val_mot20', default=False, action='store_true', help='val mot20')
    self.parser.add_argument('--test_mot20', default=False, action='store_true', help='test mot20')
    self.parser.add_argument('--val_hie', default=False, action='store_true', help='val hie')
    self.parser.add_argument('--test_hie', default=False, action='store_true', help='test hie')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/media2/funmi/MOT')
