...
class opts(object):
    def __init__(self):
        ...
        # system
        self.parser.add_argument(
            "--gpus", default="0, 1", help="-1 for CPU, use comma for multiple gpus"
        )
        self.parser.add_argument(
            "--num_workers",
            type=int,
        ...
        # tracking
        self.parser.add_argument(
            "--test_mot16", default=False, action="store_true", help="test mot16"
        )
        self.parser.add_argument(
            "--val_mot15", default=False, action="store_true", help="val mot15"
        )
        self.parser.add_argument(
            "--test_mot15", default=False, action="store_true", help="test mot15"
        )
        self.parser.add_argument(
            "--val_mot16", default=False, action="store_true", help="val mot16 or mot15"
        )
        self.parser.add_argument(
            "--test_mot17", default=False, action="store_true", help="test mot17"
        )
        self.parser.add_argument(
            "--val_mot17", default=False, action="store_true", help="val mot17"
        )
        self.parser.add_argument(
            "--val_mot20", default=False, action="store_true", help="val mot20"
        )
        self.parser.add_argument(
            "--test_mot20", default=False, action="store_true", help="test mot20"
        )
        self.parser.add_argument(
            "--val_hie", default=False, action="store_true", help="val hie"
        )
        self.parser.add_argument(
            "--test_hie", default=False, action="store_true", help="test hie"
        )
        self.parser.add_argument(
            "--conf_thres",
            type=float,
        ...
        self.parser.add_argument(
            "--id_loss", default="ce", help="reid loss: ce | triplet"
        )
        self.parser.add_argument(
            "--id_weight", type=float, default=1, help="loss weight for id"
        )
        self.parser.add_argument(
            "--pasts_weight", type=float, default=1, help="loss weight for past frames"
        )
        self.parser.add_argument(
            "--futures_weight",
            type=float,
        ...
        # forecast
        self.parser.add_argument(
            "--forecast", action="store_true", help="forecast bounding location"
        )
        self.parser.add_argument(
            "--use_embedding",
            action="store_true",
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=10,
            help="Number of previous frames to use in forecasting",
        )
        self.parser.add_argument(
            "--future_length",
            type=int,
            default=60,
            help="Number of future frames forecast",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--fixed_length",
            action="store_true",
            help="used fixed length of past and future bounding boxes",
        )
